    ...
    <section class="sidebar">	
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('buku.view')}}"><i class="ti-more"></i>Tampil Buku</a></li>
            <li><a href="invoice.html"><i class="ti-more"></i>Tambah Buku</a></li>
          </ul>
        </li> 
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('dsn.view')}}"><i class="ti-more"></i>Tampil Dosen</a></li>
            <li><a href="invoice.html"><i class="ti-more"></i>Tambah Dosen</a></li>
          </ul>
        </li> 
